...
func TestEngine_Evaluate_CriticalTool(t *testing.T) {
	...
	req := domain.PolicyRequest{
		Tool: domain.Tool{
			...
			InputSchema:      map[string]domain.ParamSchema{"name": {Type: "string", Required: true}},
		},
		Actor:       "admin",
...
func TestEngine_Evaluate_ViewerReadOnlyAllowed(t *testing.T) {
	...
	req := domain.PolicyRequest{
		Tool: domain.Tool{
			...
			InputSchema:      map[string]domain.ParamSchema{"namespace": {Type: "string", Required: false}},
		},
		Actor:       "viewer",
