...
export type Application = { id: string; tool: string; risk: Risk; role: Role; actor: string; status: 'pending' | 'approved' | 'rejected' | 'auto_approved'; reason: string; durationHrs: number; createdAt: string; decidedAt?: string; decision?: string };
